...
class NSGA2(ec.EvolutionaryComputation):
    ...
    def initialize(self, generator, evaluator, pop_size=100, seeds=None, maximize=True, bounder=None, seed_fitness=None,
                   integer_var_idx=None, parents=None, parent_fitness=None, offsprings=None, offspring_fitness=None, **args):
        return ec.EvolutionaryComputation.initialize(self, generator, evaluator, pop_size, seeds, maximize, bounder,
                                                     seed_fitness, integer_var_idx, parents, parent_fitness, offsprings, offspring_fitness, **args)

    def generate_offsprings(self):
        return ec.EvolutionaryComputation.generate_offsprings(self)

    def bound_offsprings(self):
        return ec.EvolutionaryComputation.bound_offsprings(self)

    def evaluate_fitness(self, offspring_fit=None):
        return ec.EvolutionaryComputation.evaluate_fitness(self, offspring_fit)

    def create_next_generation(self):
        return ec.EvolutionaryComputation.create_next_generation(self)
...
class PAES(ec.EvolutionaryComputation):
    ...
    def evolve(self, generator, evaluator, pop_size=1, seeds=None, maximize=True, bounder=None, **args):
        final_pop = ec.EvolutionaryComputation.evolve(self, generator, evaluator, pop_size, seeds, maximize, bounder,
                                                      **args)
        try:
